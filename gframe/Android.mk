...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../ocgcore $(LOCAL_PATH)/../event/include $(LOCAL_PATH)/../event/android $(LOCAL_PATH)/../sqlite3 $(LOCAL_PATH)/../Irrlicht/source/Irrlicht $(LOCAL_PATH)/../Irrlicht/include

LOCAL_STATIC_LIBRARIES := clzma sqlite3 lua event irrlicht
